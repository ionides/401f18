...
You are expected to use the linear modeling techniques we have learned in class, including the F test and confidence intervals.
You should also present at least one appropriate graph.

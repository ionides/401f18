...
**Grading comment**: As described in the syllabus, this will be graded on engagement with the material. Engagement implies a careful original investigation of the dataset, including the requested analysis. Correctness is one aspect of a thoughtful analysis, and so will be counted as part (but not all) of the evidence for engagement.
...
You can edit the [Rmarkdown file generating this homework](https://ionides.github.io/401f18/hw/hw11/hw11.Rmd) as a starting point. You are not expected to use the math typesetting in [$\LaTeX$ for Rmarkdown](https://www.statpower.net/Content/310/R%20Stuff/SampleMarkdown.html), though you are welcome to try it if you want to. Alternatively, you can add blank lines to handwrite equations, by using `<br>` in Rmarkdown which gives a line of blank space if you render the Rmarkdown as HTML. Writing `<br> <br> <br>` in Rmarkdown gives three blank lines, which looks like:

...
(`diff_CO2` and `diff_GDP`), (`diff_CO2` and `diff_emissions`), (`diff_pop` and `diff_emissions`), (`diff_pop` and `ENSO`), and (`diff_emissions` and `ENSO`) appear to follow joint normal distributions, since their pairwise scatterplots are approximately football shaped.

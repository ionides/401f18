...
For Questions 5, 6 and 7, you should report the results of the required calculations as well as your working. The latter should include reporting R code that you use. Please add enough explanation to help the reader understand what you did and why.
...
$(Eq. 1) \displaystyle \hspace{30mm} X=\frac{Y}{\sqrt{\sum_{j=1}^n Z_j^2/n}}$
...
$(Eq. 2) \displaystyle \hspace{30mm} X=\frac{\sum_{i=1}^m Y_i^2/m}{\sum_{j=1}^n Z_j^2/n}$
...
(c) Suppose $U\sim t(n)$ and $V\sim F(1,n)$.  Use (Eq. 1) and (Eq. 2) to explain why $U^2$ has the same distribution as $V$.

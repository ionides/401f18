...
where $x_{i,1}$ is the student's high school ranking, $x_{i,2}$ is the student's ACT score, and $z_{i,j}$ is an indicator for what year the student entered college for $j = 1997, 1998, 1999, 2000$. $\mu$ is the intercept, $\beta_1$ is the true coefficient corresponding to high school ranking, $\beta_2$ is the true coefficient corresponding to ACT score, and the $\alpha_j$'s are the true coefficients correspoding to the indicators for what year the student entered college.

**Note:** $\mu$ changes meaning between the $H_0$ and $H_a$ models. For $H_0$, it is interpreted as the mean GPA of freshmen holding high school ranking and ACT scores fixed. For $H_a$, it is interpreted as the mean GPA of freshmen who entered college in 1996.

...
Let $\vect{x_1}$ be the length of stay, $\vect{x_2}$ be the culture count, $vect{x_3}$ be the number of X-rays, and $vect{x_4}$ be the number of beds. Consider the probability model $$Y_i = \beta_0 + \beta_1x_{i1} + \beta_2x_{i2} + \beta_3x_{i3} + \beta_4x_{i4} + \epsilon_i$$ for $i = 1, \dots, 113$ where $\epsilon_i$ are iid normal($0, \sigma$).

...
1. [Getting started](01/notes01.pdf). [(R code)](01/notes01.R).

<!--
2. [Linear algebra for applied statistics](02/notes02.pdf). [(R code)](02/notes02.R).

3. [Fitting a linear model to a sample by least squares](03/notes03.pdf). [(R code)](03/notes03.R).
...
<!--
[Solutions, as a text file of R commands](hw/hw01/sol_hw01.R).
-->

<!--
* [Homework 2. More swirl and matrix exercises](hw/hw02/hw02.html). 
Due in your lab on 1/18 or 1/19. [Solutions, as a pdf file](hw/hw02/Hw2_Solutions.pdf) or [R code](hw/hw02/Hw2_Solutions.Rmd)
...
* [Lab 1. Introduction to R](Lab/Lab01/lab01.pdf) Slides for 9/7.
    [CH01PR19.txt](Lab/Lab01/CH01PR19.txt).
    [plastic_hardness.txt](Lab/Lab01/plastic_hardness.txt).

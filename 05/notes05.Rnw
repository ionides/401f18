...
"total" "final" "quiz" "hw" "midterm"
"1" 71.6 56.8 95 97 71.7
"2" 70.1 60.2 85 99 58.3
\end{verbatim}
\end{myitemize}
\begin{columns}[T]
...
\begin{column}{0.45\textwidth}
\vspace{-15mm}
<<,out.width="50mm",fig.width=3.3,fig.height=4,eval=T,echo=F,purl=F>>=
set.seed(30)
<<mvn_plot>>
@
\end{column}
...
\begin{frame}[fragile]
\begin{myitemize}
\item The covariance of \m{X} and \m{Y} \item The \myemph{sample covariance} of \m{n} pairs of measurements \m{(x_1,y_1),\dots,(x_n,y_n)} is
\mydisplaymath{

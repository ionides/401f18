...
\begin{center} $W_3$ is the sum of ($Y_1$ multiplied by 3), and ($Y_2$ and $Y_3$ both multiplied by -1). \end{center}
...
$W_3 = [3,-1,-1]\begin{bmatrix} Y_1 \\ Y_2 \\ Y_3\end{bmatrix}$ Let $\mathbb{A}_3 = [3,-1,-1]$

Let $\mathbb{A} = \begin{bmatrix} \mathbb{A}_1 \\ \mathbb{A}_2 \\ \mathbb{A}_3\end{bmatrix}$. In other words,

$$\mathbb{A} = \begin{bmatrix} 1 & 1 & 1 \\ 1 & 2 & -1 \\ 3 & -1 & -1 \end{bmatrix}$$

# Lab Activity Solutions (Part 3)

Then $E[\boldsymbol{W}] = \begin{bmatrix} 12 \\ 4 \\ -4\end{bmatrix}$

Then $Var(\boldsymbol{W}) = \begin{bmatrix} 31 & 24 & 13 \\ 24 & 5 & 4 \\ 13 & 4 & 39 \end{bmatrix}$
...
1. $\mathbb{A} = [1, -1, 0]$. $E[\mathbb{A}\boldsymbol{Y}] = -2$ and $Var(\mathbb{A}\boldsymbol{Y}) = 6$. Then $P(Y_1 > Y_2)$ = `pnorm(0, -2, 6, lower.tail = F)` = 0.3694413.

1. $\mathbb{A} = [-2, 2, 2]$. $E[\mathbb{A}\boldsymbol{Y}] = 16$ and $Var(\mathbb{A}\boldsymbol{Y}) = 44$. Then $P(W_1 > W_3)$ = `pnorm(0, 16, 44, lower.tail = F)` = 0.6419352.

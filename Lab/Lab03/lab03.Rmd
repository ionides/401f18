...
lmod2
```
In this case "y ~ ., data = df" tells R that the data are contained in df, where y is the response variable, and "." tells us to use all the remaining variables as predictors. Once again, R includes the intercept for us
